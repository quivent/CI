...
echo "   ci --help                          # Show all commands"
echo "   ci agent list                      # List available agents"
echo "   ci agent voice AGENT_NAME          # Launch agent in voice mode (auto-accept)"
echo "   ci agent load AGENT_NAME --free    # Load agent with auto-accept enabled"
echo ""
echo "📚 Voice Mode Features:"
echo "   • Automatic Claude Code launch with --auto-accept"
echo "   • No confirmation prompts for streamlined workflow"  
echo "   • Configuration-based auto-accept settings"
echo ""
echo "📖 For complete documentation: docs/VOICE_MODE.md"
echo ""
echo "🚀 Ready to use the Collaborative Intelligence CLI!"